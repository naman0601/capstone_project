    ...
    const handleSubmit = async (e) => {
        ...
        if (isFormValid) {
            try {
                ...
                setLoginError('An error occurred while attempting to log in. Please try again later.');
            }
        }
    };
        ...
        <div className="container">
            <div className='row'>
                <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                    <h2 className="text-center "style={{color:"purple"}}>LOGIN</h2>
                    <form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <p className="mt-2">
              First time user? <Link to="/register" style={{color:"purple"}}>Register here</Link>
            </p>
                    </form>
                </div>
            </div>
